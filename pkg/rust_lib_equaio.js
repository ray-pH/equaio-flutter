 ...
 * @param {number} ptr
 */
__exports.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionLine = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionLine(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionLine = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionLine(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionWrapper(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerExpressionWrapper(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorkableExpressionSequenceWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorkableExpressionSequenceWrapper(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorkableExpressionSequenceWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorkableExpressionSequenceWrapper(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorksheetWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorksheetWrapper(ptr);
};

/**
 * @param {number} ptr
 */
__exports.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorksheetWrapper = function(ptr) {
    _assertNum(ptr);
    wasm.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWorksheetWrapper(ptr);
};
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_3aabf7adafeda50f = function() { return logError(function (arg0, arg1) {
        console.log(getStringFromWasm0(arg0, arg1));
    }, arguments) };
    imports.wbg.__wbg_error_ed81bf5985e334c9 = function() { return logError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_postMessage_4b03ef3c6e58db4c = function() { return handleError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_instanceof_MessagePort_ad66b3167b6b3890 = function() { return logError(function (arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbindgen_closure_wrapper3279 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 92, __wbg_adapter_32);
        return ret;
    }, arguments) };
    imports.wbg.__wbindgen_closure_wrapper3792 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 135, __wbg_adapter_35);
        return ret;
    }, arguments) };
